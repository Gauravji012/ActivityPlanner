...
const Connection = () => {
    const MONGODB_URI = `mongodb+srv://${USERNAME}:${PASSWORD}@user.stn0ww5.mongodb.net/?retryWrites=true&w=majority&appName=user`;
    
    // mongodb+srv://${USERNAME}:${PASSWORD}@mern-todo.faxycy0.mongodb.net/?retryWrites=true&w=majority;
